...
const install = function (Vue, opts = {}) { // eslint-disable-line no-unused-vars
  ...
  Vue.prototype.$bmToast = Toast.root;
  Vue.prototype.$bmTooltip = Tooltip.root;
  Vue.prototype.$bmLoading = Loading.root;
  Vue.prototype.$bmAlert = Alert.root;
  Vue.prototype.$bmConfirm = Confirm.root;
};
