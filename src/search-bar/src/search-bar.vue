  ...
  <div :class="prefixCls">
    <form action="#" :class="{
      ...
      <div :class="{
        ...
        <bm-input type="search" :class="`${prefixCls}__input`" :placeholder="placeholder || placeholderText" :value="currentValue" :disabled="disabled" :clearable="clearable" ref="inputRef"
...
import bmInput from '../../input/src/input';
